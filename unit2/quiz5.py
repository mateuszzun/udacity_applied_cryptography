...
def swap_blocks(block_a, block_b, cblock_a, cblock_b):
    ...
    nblock_a = xor_bits(eblock_a, cblock_b)
    nblock_b = xor_bits(eblock_b, cblock_a)
    return nblock_a, nblock_b
...
def find_collision(message):
    ...
    block_a = message[0:block_size]
    block_b = message[block_size:2*block_size]
    cblock_a = cipher[0:block_size]
    cblock_b = cipher[block_size:2*block_size]
    
    nblock_a, nblock_b = swap_blocks(block_a, block_b, cblock_a, cblock_b)
    
    new_message[0:block_size] = nblock_a
    new_message[block_size:2*block_size] = nblock_b
